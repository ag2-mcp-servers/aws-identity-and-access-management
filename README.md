...
This project is an MCP (Multi-Agent Conversation Protocol) Server for the given OpenAPI URL - https://api.apis.guru/v2/specs/amazonaws.com/iam/2010-05-08/openapi.json, auto-generated using AG2's [MCP builder](https://mcp.ag2.ai).
